  ...
  <div class="footer-top">
    <div class="container d-xl-flex justify-content-between align-items-center">
      <div class="social d-flex align-items-center justify-content-center">
        ...
        <div class="icons">
          <a href="https://business.facebook.com/ConfianceInvestIleDeFrance"><i class="fab fa-facebook-square"></i></a>
          <a href="https://www.instagram.com/confianceinvest/"><i class="fab fa-instagram"></i></a>
          <a href="https://twitter.com/ConfianceINVST"><i class="fab fa-twitter-square"></i></a>
        </div>
      </div>
          ...
          <form id="form-wysija-shortcode5c0018e4e390b-1" method="post" action="#wysija" class="widget_wysija shortcode_wysija">
            <p class="wysija-paragraph">
              <input type="text" name="wysija[user][email]" class="wysija-input validate[required,custom[email]]"
               title="Votre e-mail" placeholder="Email" value="">
            </p>
            <input class="wysija-submit wysija-submit-field" type="submit" value="Je m'abonne !">
          </form>
        </div>
      </div>
      <div class="politique-link d-flex align-items-center justify-content-center">
        © 2018 | <a href="/mentions-legales/">Politique de confidentialité</a>
      </div>
    </div>
  </div>
